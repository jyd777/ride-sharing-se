...
(function(vue) {
  ...
  const request = (options) => {
    ...
    formatAppLog("log", "at utils/request.js:111", token);
    ...
    methods: {
      login() {
        ...
        authApi.login({
          ...
          var _a;
          formatAppLog("log", "at pages/index/login.vue:86", "登陆失败：", err);
  ...
  const PagesIndexLogin = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f], ["__scopeId", "data-v-fa14255b"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/login.vue"]]);
  const _imports_0$3 = "/static/car-icon.png";
  ...
  const NavigationBar = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__scopeId", "data-v-e29e7744"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/components/NavigationBar.vue"]]);
  const _sfc_main$e = {
    components: {
      NavigationBar
    },
  ...
  const PagesIndexChatlist = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d], ["__scopeId", "data-v-c2d98f75"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/chatlist.vue"]]);
  ...
  const fetchManagedOrders = (params) => {
    formatAppLog("log", "at api/order.js:53", params.status || "all");
    return get("/orders/manage/list", {
      ...
      formatAppLog("log", "at api/order.js:62", response.data);
  ...
  const PaymentModal = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c], ["__scopeId", "data-v-d0c78149"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/components/PaymentModal.vue"]]);
    ...
    methods: {
      ...
      fetchTripDetails() {
        if (!this.orderId)
          return;
        this.isLoading = true;
        fetchTripDetail(this.orderId).then((res) => {
          formatAppLog("log", "at pages/index/trip_info.vue:165", "行程详情获取成功:", res);
      ...
      getDrivingRoute(startPos, endPos) {
        return new Promise((resolve, reject) => {
          uni.request({
            ...
            success: (res) => {
              formatAppLog("log", "at pages/index/trip_info.vue:294", "高德驾车路线API响应:", res.data);
              if (res.data.status === "1" && res.data.route) {
                resolve(res.data.route);
              } else {
                formatAppLog("error", "at pages/index/trip_info.vue:298", "驾车路径规划失败:", res.data.info || "未知错误");
                resolve(null);
              }
            },
            fail: (err) => {
      ...
      transFormAddress(address) {
        return new Promise((resolve, reject) => {
          uni.request({
            ...
            success: (res) => {
              formatAppLog("log", "at pages/index/trip_info.vue:319", `地址解析 "${address}" 响应:`, res.data);
              if (res.data && res.data.info === "OK" && res.data.geocodes && res.data.geocodes.length > 0) {
                ...
                formatAppLog("error", "at pages/index/trip_info.vue:325", `地址解析失败 "${address}":`, res.data.info || "无结果");
                resolve(null);
              }
            },
            fail: (err) => {
      ...
      submitRating() {
        ...
        submitTripRating(this.orderId, payload).then((res) => {
          formatAppLog("log", "at pages/index/trip_info.vue:387", "评价提交成功:", res);
          uni.showToast({
            title: "评价成功！",
            icon: "success"
          });
  ...
  const PagesIndexTripInfo = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-c77841f1"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/trip_info.vue"]]);
  const _sfc_main$b = {
    data() {
      return {
        user: {
  ...
  const PagesIndexRegister = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-224dede7"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/register.vue"]]);
  const fetchUserVehicles = (userId) => {
  ...
  const fetchUserBaseInfo = (userId) => {
    return get(`/user/basic/${userId}`).then((res) => {
      ...
      formatAppLog("error", "at api/user.js:24", "Error fetching user base info:", error2);
      throw error2;
    });
  };
  ...
  const fetchUserAvatar = (userId) => {
    return get(`/user/avatar/${userId}`).then((res) => {
      if (!res || !res.data) {
        formatAppLog("error", "at api/user.js:111", "Invalid data received for user avatar:", res);
        return getDefaultAvatar();
      }
      return res.data.avatar_url || getDefaultAvatar();
    }).catch((error2) => {
      formatAppLog("error", "at api/user.js:116", "Error fetching user avatar:", error2);
      return getDefaultAvatar();
    });
  };
    ...
    methods: {
      ...
      async approveOrder(orderId) {
        try {
          ...
          formatAppLog("error", "at pages/index/manage.vue:165", "审核通过失败:", error2);
        }
      },
          ...
          success: async (res) => {
            if (res.confirm && res.content) {
              try {
                ...
                formatAppLog("error", "at pages/index/manage.vue:188", "拒绝订单失败:", error2);
              }
            }
          }
        });
  ...
  const PagesIndexManage = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-4652816d"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/manage.vue"]]);
  const _sfc_main$8 = {
    components: {
      NavigationBar
    },
    ...
    methods: {
      ...
      async fetchVehicleList() {
        ...
        try {
          ...
          formatAppLog("error", "at pages/index/order_launch.vue:292", "请求车辆列表接口异常:", error2);
      ...
      async searchAddress(query, type) {
        try {
          ...
          formatAppLog("error", "at pages/index/order_launch.vue:345", "地址搜索 API 请求失败:", error2);
          if (type === "start")
            this.startSuggestions = [];
          else
            this.endSuggestions = [];
      ...
      async drawRoute() {
        ...
        try {
          ...
          formatAppLog("error", "at pages/index/order_launch.vue:460", "路线规划 API 请求失败:", error2);
          this.polyline = [];
        }
      },
      handleDateChange(e) {
      ...
      async handlePublish() {
        ...
        try {
          ...
          uni.hideLoading();
          if (res.code === 200) {
            formatAppLog("log", "at pages/index/order_launch.vue:585", "订单发布成功");
            uni.showToast({
              title: `发布成功`,
              icon: "success",
              duration: 2e3
            ...
            formatAppLog("error", "at pages/index/order_launch.vue:597", "订单发布失败，后端返回:", res);
          ...
          uni.hideLoading();
          formatAppLog("error", "at pages/index/order_launch.vue:607", error2);
        } finally {
    ...
    methods: {
      ...
      async fetchUserTrips() {
        try {
          const cacheUserID = uni.getStorageSync("user_id");
          if (!cacheUserID) {
            formatAppLog("error", "at pages/index/person.vue:206", "用户ID不存在");
            return;
          }
          ...
          if (res.code === 200) {
            ...
            formatAppLog("error", "at pages/index/person.vue:224", "获取行程数据失败:", res.error);
          }
        } catch (error2) {
          formatAppLog("error", "at pages/index/person.vue:227", "获取行程数据异常:", error2);
        }
      }
    },
    mounted() {
  ...
  const PagesIndexPerson = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/person.vue"]]);
  var calendar = {
    /**
        * 农历1900-2100的润大小信息表
        * @Array Of Property
  ...
  const CalendarItem = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-65626c58"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/uni_modules/uni-calendar/components/uni-calendar/uni-calendar-item.vue"]]);
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-b6ab2cfb"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/uni_modules/uni-calendar/components/uni-calendar/uni-calendar.vue"]]);
  const _sfc_main$4 = {
    components: {
      NavigationBar
    },
  ...
  const PagesIndexInfoManage = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-2cb089b3"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/info_manage.vue"]]);
  ...
  const PagesIndexHome = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-760d994e"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/home.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        latitude: 0,
  ...
  const PagesIndexRecord = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-01d8b9db"], ["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/pages/index/record.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/jiang/Desktop/软工拼车/car-sharing/github/ride-sharing-se/App.vue"]]);
  function createApp() {
